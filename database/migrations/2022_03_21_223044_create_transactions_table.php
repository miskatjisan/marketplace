...
return new class extends Migration {
	...
	public function up ()
	{
		...
		Schema::create('transactions', function (Blueprint $table) {
			...
			$table->foreignId('dep_id')->nullable()->references('id')->on('user_deposits')->onDelete('NO ACTION');
			$table->foreignId('with_id')->nullable()->references('id')->on('withdraws')->onDelete('NO ACTION');
