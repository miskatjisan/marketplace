...
Route::group(['middleware' => ['auth', 'uverify']], function () {
    Route::prefix('user')->group(function () {
        ...
        Route::post('/freelancer-report-submit', [Controllers\User\UserJobController::class, 'freelancer_report_submit'])->name('user.report.freelancer');
        //deposit
...
Route::group(['middleware' => ['auth:admin']], function () {
    Route::prefix('admin')->group(function () {
        ...
        Route::get('/user-task-report-make-reviewed/{id}', [Controllers\Admin\AdminReportController::class, 'job_task_report_make_reviewed'])->name('admin.user.task.report.makereviewed');
         ...
         //freelancer report
         Route::get('/freelancer-report', [Controllers\Admin\AdminReportController::class, 'freelancer_report'])->name('admin.freelancer.report');
         Route::get('/freelancer-report-get', [Controllers\Admin\AdminReportController::class, 'freelancer_report_get'])->name('admin.freelancer.report.get');
