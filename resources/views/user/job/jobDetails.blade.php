                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        ...
                                                        <option value="Time Duration Report">Time Duration Report</option>
                                                        <option value="Job Description Report">Job Description Report</option>
                                                        <option value="Requirement Report">Requirement Report</option>
                                                        <option value="Budget Report">Budget Report</option>
                                                        <option value="Others Report">Job Description Report</option>
                                                    </select>
                                                        ...
                                                        <textarea class="form-control" cols="5" rows="5"
                                                                  ...
                                                                  <input type="hidden" value="{{$job_details->user_id}}"
                                                               name="buyer_id">
</br>
