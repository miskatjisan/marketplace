...
{{--                    </div>--}}
                    ...
                    <div class="dropdown d-inline-block ">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                            ...
                            <div data-simplebar style="max-height: 230px;">
                                ...
                                <a href="javascript: void(0);" class="text-reset notification-item">
                                    <div class="d-flex">
                                        <img src="{{asset('assets/userdas/')}}/images/users/avatar-3.jpg"
                                ...
                                <a href="javascript: void(0);" class="text-reset notification-item">
                                    <div class="d-flex">
                                        <img src="{{asset('assets/userdas/')}}/images/users/avatar-4.jpg"
                                             class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                        <div class="flex-grow-1">
                    ...
                    <div class="dropdown d-inline-block">
                        <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="rounded-circle header-profile-user" src="{{asset('assets/userdas/')}}/images/users/avatar-1.jpg"
                                 alt="Header Avatar">
        ...
        <div data-simplebar class="h-100">
            ...
            <div id="sidebar-menu">
                ...
                <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    <li>
                        <a href="{{route('admin.region.country')}}" class="waves-effect">
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{route('admin.job.main.category')}}">Main Category</a></li>
                            <li><a href="{{route('admin.job.sub.category')}}">Sub Category</a></li>
                        </ul>
                    </li>

                    <li>
                        <a href="{{route('admin.find.job')}}" class="waves-effect">
                            <i class="bx bx-flag"></i>
                            <span>Find Job</span>
                        </a>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{route('admin.all.jobs')}}">All Jobs</a></li>
                            <li><a href="{{route('admin.pending.jobs')}}">Pending Jobs</a></li>
                            <li><a href="{{route('admin.approved.jobs')}}">Approved Jobs</a></li>
                            <li><a href="{{route('admin.rejected.jobs')}}">Rejected Jobs</a></li>
                        </ul>
                    </li>

                    <li>
                        <a href="{{route('admin.payment.gateway')}}" class="waves-effect">
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{route('admin.all.deposit')}}">All Deposit</a></li>
                            <li><a href="{{route('admin.pending.deposit')}}">Pending Deposit</a></li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{route('admin.all.withdraw')}}">All Withdraw</a></li>
                            <li><a href="{{route('admin.pending.withdraw')}}">Pending Withdraw</a></li>
                            <li><a href="{{route('admin.approved.withdraw')}}">Approved Withdraw</a></li>
                            <li><a href="{{route('admin.rejected.withdraw')}}">Rejected Withdraw</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="{{route('admin.all.subadmin')}}" class="waves-effect">
                            <i class="mdi mdi-head-minus-outline"></i>
                            <span>Sub Admin</span>
                        </a>
                    </li>
...
<li>
   <a class="waves-effect"> <i class="mdi mdi-alert-octagon"></i> <span> Report </span> </a>
   <ul class="nav child_menu">
   <li>
                        <a href="{{route('admin.job.report')}}" class=" waves-effect">
                    ...
                    <li>
                        <a href="{{route('admin.user.task.report')}}" class="waves-effect">
                            <i class="mdi mdi-calendar-check-outline"></i>
                            <span>User Task Report</span>
                        </a>
                    </li>

                    <li>
                        <a href="{{route('admin.freelancer.report')}}" class=" waves-effect">
                            <i class="mdi mdi-alert-octagon"></i>
                    ...
                    <li>
                        <a href="{{route('admin.user.ip')}}" class="waves-effect">
                            <i class="mdi mdi-ip-network-outline"></i>
                            <span>User IP</span>
                        </a>
                    </li>
                    <li>
                        <a href="account-verification.html" class="waves-effect">
