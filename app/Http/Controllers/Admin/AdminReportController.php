...
class AdminReportController extends Controller
{
    ...
    {
       $job_reports= job_report::all();
        return view('admin.report.jobReport',compact('job_reports'));
    }
    ...
    {
        $buyer_reports = apply_member_report::all();
        return view('admin.report.jobTaskReport',compact('buyer_reports'));
    }
...
public function freelancer_report(){
    $freelancer_reports = freelancer_report::all();
    return view('admin.report.jobfreelancerReport',compact('freelancer_reports'));
}

public function freelancer_report_get()
{
    $all_report = freelancer_report::all();
    return DataTables::of($all_report)
        ->addColumn('action', function ($all_report) {
            return '
            <button id="' . $all_report->id . '" onclick="editmaincat(this.id)" type="button" class="btn btn-sm btn-light editcatmd" data-bs-toggle="modal" data-bs-target="#editmaincategory">View</button>
